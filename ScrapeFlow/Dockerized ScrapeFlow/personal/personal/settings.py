...
SECRET_KEY = 'django-insecure-6bm^cv4q=^(=r2ky0uozjp@4tl+e8q_swl8qd0zcjdt-mkk2=k'
...
TIME_ZONE = 'Asia/Tbilisi'  # Set timezone to Tbilisi
...
CELERY_TIMEZONE = TIME_ZONE  # Make Celery use the same timezone

# Celery Beat Configuration
CELERY_BEAT_SCHEDULE = {
    'process-scraping-schedules': {
        'task': 'scraper.tasks.process_scraping_schedules',
