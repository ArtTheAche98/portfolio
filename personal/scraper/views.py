...
import requests
import jwt  # add this import at the top if not present
import datetime
    ...
    features = [
        {
            ...
            'description': 'Build powerful scrapers with our visual editor. No programming required.'
        },
        {
        ...
        },
        {
            ...
            'description': 'Export your data in multiple formats with one click.'
        }
    ]
